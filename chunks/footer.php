		<div id="footer">
			<div class="container">
				<p class="text-muted">
					...
					<small class="pull-right">&nbsp;v0.2.0-pl</small><a href="<?php echo Yii::app()->params['VK.group']; ?>" target="_blank" class="pull-right small">Группа ВКонтакте</a><span class="pull-right">,&nbsp;</span><a href="http://dev.earthperson.info" target="_blank" class="pull-right small">Разработка</a>
				</p>
			</div>
		</div>
