...
<div class="container">
	...
	<ul>
		<li>Положите футболки <a href="<?= EshopHelper::createUrl('cart') ?>">в корзину</a> выбрав те, которые Вам нравятся. Для футболок относящихся к хитам продаж 
		...
		<li>Вы можете внести предоплату через этот сайт. Подробнее читайте на странице <a href="<?= EshopHelper::createUrl('payment') ?>">Способы оплаты</a>.</li>
		<li>Спасибо, что выбрали футболки от  <?= Html::encode(Yii::$app->name) ?>. В этих футболках у Вас всегда будет хорошее настроение!</li>
	</ul>
</div>
