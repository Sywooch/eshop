...
<div class="container">
	...
	<p><?= \Yii::t('app', 'Отзывы о нас читайте на стене') ?> <a href="<?= Yii::$app->params['VK.group'] ?>" target="_blank"><img src="images/<?= strpos(Yii::$app->language, 'ru') !== false ? 'vk' : 'fb' ?>.png" width="16" height="16" alt="" title="<?= \Yii::t('app', 'Группа ВКонтакте') ?>"></a> <a href="<?= Yii::$app->params['VK.group'] ?>" target="_blank"><?= \Yii::t('app', 'группы ВКонтакте') ?></a>.</p>
